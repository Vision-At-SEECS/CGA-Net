...
## Channel Attention (CGA) Layer
class CGALayer(nn.Module):
    def __init__(self, channel, reduction=16):
        super(CGALayer, self).__init__()
...
class RCAB(nn.Module):
    def __init__(
        ...
        modules_body.append(CGALayer(n_feat, reduction))
...
## Channel-Wise Gated Attention Network (CGAN)
